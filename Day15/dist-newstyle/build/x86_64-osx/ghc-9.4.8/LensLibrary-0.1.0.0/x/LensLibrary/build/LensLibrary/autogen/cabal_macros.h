...
/* package LensLibrary-0.1.0.0 */
#ifndef VERSION_LensLibrary
#define VERSION_LensLibrary "0.1.0.0"
#endif /* VERSION_LensLibrary */
#ifndef MIN_VERSION_LensLibrary
#define MIN_VERSION_LensLibrary(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_LensLibrary */
...
#define CURRENT_COMPONENT_ID "LensLibrary-0.1.0.0-inplace-LensLibrary"
